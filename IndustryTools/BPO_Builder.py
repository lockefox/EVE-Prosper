...
def XML_builder (BPO_obj, dict_of_BPOs):
	...
	blueprint.set("techLevel",str(BPO_obj.BPO_properties["tech_level"]))
...
def JSON_builder (BPO_obj, dict_of_BPOs):
	global json_tree
...
def main():
	...
	for BPO_typeID,bpo_obj in BPO_lookup.iteritems():
		...
		JSON_builder(bpo_obj,BPO_lookup)
